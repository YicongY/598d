...
class TripleDataset(Dataset):
    ...
    def __getitem__(self, idx):
        if self.train :
            ...
            subdir = label
            query_image_path = root_dir + '/'+ subdir + '/' + triple_list[idx][0]
            positive_image_path = root_dir + '/'+ subdir + '/' + triple_list[idx][1]
            negative_label = triplelist[idx][2].split('_')[0]
            subdir = negative_label
            negative_image_path =root_dir + '/'+ subdir + '/' + triple_list[idx][2]
